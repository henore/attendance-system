...
const reportsRouter = require('./routes/reports')(dbGet, dbAll, dbRun, requireAuth, requireRole);
const approvalRouter = require('./routes/approval')(dbGet, dbAll, dbRun, requireAuth, requireRole);
const monthlyAttendanceRouter = require('./routes/monthly-attendance')(dbGet, dbAll, dbRun, requireAuth, requireRole);
...
app.use('/api/reports', requireAuth, requireRole(['staff', 'admin']), reportsRouter);
app.use('/api/approval', requireAuth, requireRole(['staff', 'admin']), approvalRouter);
app.use('/api/monthly-attendance', requireAuth, requireRole(['staff', 'admin']), monthlyAttendanceRouter);
